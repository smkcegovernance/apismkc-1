-- =====================================================
-- Stored Procedure: SP_BANK_LOGIN
-- Description: Authenticates bank users
-- Database: ULBERP
...
CREATE OR REPLACE PROCEDURE SP_BANK_LOGIN (
...
-- =====================================================
-- GRANT EXECUTE ON SP_BANK_LOGIN TO <API_USER>;
