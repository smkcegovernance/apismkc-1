-- =====================================================
-- Stored Procedure: SP_COMMISSIONER_LOGIN
-- Description: Authenticates commissioner users
-- Database: ULBERP
...
CREATE OR REPLACE PROCEDURE SP_COMMISSIONER_LOGIN (
...
BEGIN
  ...
  OPEN O_USER_DATA FOR
    SELECT 
      ...
      'commissioner' AS ROLE,    -- Commissioner role
      V_USER_NAME AS NAME,
      V_STATUS AS STATUS
    FROM DUAL;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    OPEN O_USER_DATA FOR SELECT NULL FROM DUAL WHERE 1=0;
END SP_COMMISSIONER_LOGIN;
/

-- =====================================================
-- Grant Execute Permission
-- =====================================================
-- GRANT EXECUTE ON SP_COMMISSIONER_LOGIN TO <API_USER>;
...
BEGIN
  SP_COMMISSIONER_LOGIN(
    P_USER_ID => 'testcommissioner',
